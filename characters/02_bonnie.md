...
- Always moves from `ShowStage` $\to$ `DiningArea` $\to$ `Hallway` $\to$ `Doorway`, on the left.
- At your door, a growling sound will play. If Bonnie would move again, it's a jumpscare. If your camera is up 2.5 seconds after Bonnie arrives at your doorway, it's a jumpscare.
Closing the correct door for 0.5 seconds resets him.
